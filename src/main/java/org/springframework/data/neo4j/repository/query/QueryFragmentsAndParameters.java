...
public final class QueryFragmentsAndParameters {
	...
	static QueryFragmentsAndParameters forExample(Neo4jMappingContext mappingContext, Example<?> example, java.util.function.Predicate<PropertyFilter.RelaxedPropertyPath> includeField) {
	...
	static QueryFragmentsAndParameters forExample(Neo4jMappingContext mappingContext, Example<?> example, Sort sort, java.util.function.Predicate<PropertyFilter.RelaxedPropertyPath> includeField) {
	...
	static QueryFragmentsAndParameters forExample(Neo4jMappingContext mappingContext, Example<?> example, Pageable pageable, java.util.function.Predicate<PropertyFilter.RelaxedPropertyPath> includeField) {
